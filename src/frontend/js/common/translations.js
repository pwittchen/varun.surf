...
export const translations = {
    en: {
        ...
        mcpToolGetWindForecast: "Returns the hour-by-hour wind forecast for a single spot: wind, gusts and direction for every hour, with the windiest hour and the kiteable ones called out.",
        mcpToolFindSpotByName: "Finds spots whose name contains the given query (case-insensitive).",
        mcpToolFindWindySpots: "Searches every spot at once for the ones reaching a given wind speed in the hours ahead, with the windy hours, peak wind, gusts and direction.",
        ...
        mcpLlmsSpotWindDescription: "Hour-by-hour wind, gusts and direction for a single spot. Query parameters: <code>hours</code> and <code>minWind</code>.",
        mcpLlmsWindDescription: "Every spot reaching a given wind speed in the hours ahead, strongest first. Query parameters: <code>minWind</code>, <code>hours</code>, <code>country</code> and <code>limit</code>.",
        ...
        metricsIcmAnalysis: "ICM Forecast (AI)",
        metricsOnDemandTitle: "On-demand Data Fetching",
        ...
        metricsProxyTitle: "Outgoing Proxy",
        metricsProxyLiveStations: "Live Stations",
        metricsProxyOther: "Other (Maps, ICM)",
        metricsProxyEndpoint: "Proxy:",
        metricsProxyConnections: "Connections (proxy / direct):",
        metricsProxyNote: "Each target goes through the Oxylabs residential proxy only when switched on. OpenAI requests are never proxied.",
        metricsProxyProxied: "Proxied",
        metricsProxyDirect: "Direct",
        metricsProxyMissingCredentials: "Direct (no credentials)",
        metricsProxyNotConfigured: "not configured",
        ...
        heroCloseModalTitle: "Hide banner",
        heroCloseModalQuestion: "Do you really want to hide the banner with the spot photo?",
        heroCloseModalHint: "You can bring it back any time with the Banner button in the menu on the left.",
        heroCloseModalCancel: "Cancel",
        heroCloseModalConfirm: "Hide banner",
        aiAnalysisGeneratedAt: "Generated:",
        aiDisclaimer: "⚠️ This data is generated by AI and may contain errors or invalid information! It may also be outdated: to keep the costs down the analysis is generated on request and stays valid for 24 hours, while the forecast itself is updated every 3 hours.",
        generateAiAnalysisButton: "Generate AI analysis",
        ...
        generateAiAnalysisError: "The AI analysis could not be generated. Try again later.",
        ...
        generatingIcmForecast: "Generating ICM forecast...",
        generateIcmForecastError: "The ICM forecast could not be generated. Try again later.",
        ...
        windOverlayShow: "Show wind field",
        windOverlayHide: "Hide wind field",
        windOverlayDisclaimer: "Interpolated from spot data",
        mapSpotsShow: "Show spots",
        mapSpotsHide: "Hide spots",
        mapClusterSpotsLabel: "spots - click to zoom in",
        mapSidePeekOpen: "Details",
        mapSidePeekClose: "Close details",
        mapSidePeekForecast: "Forecast",
        mapSidePeekAbout: "About the spot",
        mapSidePeekOpenSpot: "Open spot page",
    ...
    pl: {
        ...
        sidebarFiring: "Najsilniejszy wiatr",
        sidebarLiveStations: "Na żywo",
        ...
        mcpToolGetWindForecast: "Zwraca godzinową prognozę wiatru dla jednego spotu: wiatr, porywy i kierunek dla każdej godziny, z wyróżnieniem godziny z najsilniejszym wiatrem i godzin nadających się do pływania.",
        mcpToolFindSpotByName: "Wyszukuje spoty, których nazwa zawiera podaną frazę (bez rozróżniania wielkości liter).",
        mcpToolFindWindySpots: "Przeszukuje wszystkie spoty naraz w poszukiwaniu tych, na których w najbliższych godzinach wiatr osiągnie zadaną prędkość, wraz z godzinami z wiatrem, jego maksimum, porywami i kierunkiem.",
        ...
        mcpLlmsSpotWindDescription: "Wiatr, porywy i kierunek godzina po godzinie dla jednego spotu. Parametry zapytania: <code>hours</code> i <code>minWind</code>.",
        mcpLlmsWindDescription: "Wszystkie spoty, na których wiatr osiągnie zadaną prędkość w najbliższych godzinach, od najsilniejszego. Parametry zapytania: <code>minWind</code>, <code>hours</code>, <code>country</code> i <code>limit</code>.",
        ...
        metricsIcmAnalysis: "Prognoza ICM (AI)",
        metricsOnDemandTitle: "Pobieranie danych na żądanie",
        ...
        metricsProxyTitle: "Proxy dla ruchu wychodzącego",
        metricsProxyLiveStations: "Stacje pomiarowe",
        metricsProxyOther: "Pozostałe (mapy, ICM)",
        metricsProxyEndpoint: "Proxy:",
        metricsProxyConnections: "Połączenia (proxy / bezpośrednie):",
        metricsProxyNote: "Ruch idzie przez proxy rezydencjalne Oxylabs tylko tam, gdzie je włączono. Zapytania do OpenAI nigdy nie idą przez proxy.",
        metricsProxyProxied: "Przez proxy",
        metricsProxyDirect: "Bezpośrednio",
        metricsProxyMissingCredentials: "Bezpośrednio (brak danych logowania)",
        metricsProxyNotConfigured: "nie skonfigurowano",
        ...
        heroCloseModalTitle: "Ukryj baner",
        heroCloseModalQuestion: "Czy na pewno chcesz zamknąć baner ze zdjęciem spotu?",
        heroCloseModalHint: "Możesz go włączyć z powrotem w każdej chwili przyciskiem Baner w menu po lewej.",
        heroCloseModalCancel: "Anuluj",
        heroCloseModalConfirm: "Ukryj baner",
        aiAnalysisGeneratedAt: "Wygenerowano:",
        aiDisclaimer: "⚠️ Te dane są generowane przez AI i mogą zawierać błędy lub nieprawidłowe informacje! Mogą być też nieaktualne: dla optymalizacji kosztów analiza jest generowana na żądanie i jest ważna przez 24 godziny, a sama prognoza jest aktualizowana co 3 godziny.",
        generateAiAnalysisButton: "Generuj analizę AI",
        ...
        generateAiAnalysisError: "Nie udało się wygenerować analizy AI. Spróbuj ponownie później.",
        ...
        generatingIcmForecast: "Generowanie prognozy ICM...",
        generateIcmForecastError: "Nie udało się wygenerować prognozy ICM. Spróbuj ponownie później.",
        ...
        windOverlayShow: "Pokaż pole wiatru",
        windOverlayHide: "Ukryj pole wiatru",
        windOverlayDisclaimer: "Interpolacja z danych spotów",
        mapSpotsShow: "Pokaż spoty",
        mapSpotsHide: "Ukryj spoty",
        mapClusterSpotsLabel: "spotów - kliknij, aby przybliżyć",
        mapSidePeekOpen: "Szczegóły",
        mapSidePeekClose: "Zamknij szczegóły",
        mapSidePeekForecast: "Prognoza",
        mapSidePeekAbout: "O spocie",
        mapSidePeekOpenSpot: "Otwórz stronę spotu",
