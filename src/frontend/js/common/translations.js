...
export const translations = {
    en: {
        ...
        aiDisclaimer: "⚠️ This data is generated by AI and may contain errors or invalid information! It may also be outdated: to keep the costs down the analysis is generated every 24 hours, while the forecast itself is updated every 3 hours.",
    ...
    pl: {
        ...
        aiDisclaimer: "⚠️ Te dane są generowane przez AI i mogą zawierać błędy lub nieprawidłowe informacje! Mogą być też nieaktualne: dla optymalizacji kosztów analiza jest generowana co 24 godziny, a sama prognoza jest aktualizowana co 3 godziny.",
