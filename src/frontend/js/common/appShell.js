...
<div class="header-content">
    <div class="header-actions">
        <button class="theme-toggle" id="languageToggle" title="Change language" data-lang="en">
            <svg class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            <!-- Desktop: both languages on screen at once, the one in use
                 filled. Hidden in the mobile drawer, where the globe above
                 plus the code below is the whole control. -->
...
// Mark which half of the language switch is the live one. The pages already
// write the current code into #langCode on every switch — this is the same
// update for the desktop form of the control, which shows both languages and
// fills the one in use.
export function updateLanguageSwitch(lang) {
